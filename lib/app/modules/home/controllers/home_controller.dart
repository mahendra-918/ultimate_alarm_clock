...
class HomeController extends GetxController {
  ...
  AlarmModel genFakeAlarmModel() {
    return AlarmModel(
        ...
        isNegativeWeatherEnabled: profileModel.value.isNegativeWeatherEnabled,
        isEnabled: profileModel.value.isEnabled,
        isActivityEnabled: profileModel.value.isActivityEnabled,
        isNegativeActivityEnabled: profileModel.value.isNegativeActivityEnabled,
        isLocationEnabled: profileModel.value.isLocationEnabled,
        isNegativeLocationEnabled: profileModel.value.isNegativeLocationEnabled,
