...
const AlarmModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isSmartHomeEnabled': PropertySchema(
      id: 23,
      name: r'isSmartHomeEnabled',
      type: IsarType.bool,
    ),
...
void _alarmModelSerialize(
  ...
  writer.writeBool(offsets[23], object.isSmartHomeEnabled);
...
AlarmModel _alarmModelDeserialize(
  ...
  final object = AlarmModel(
    ...
    isSmartHomeEnabled: reader.readBoolOrNull(offsets[23]) ?? false,
...
extension AlarmModelQueryFilter
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterFilterCondition>
      isSmartHomeEnabledEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSmartHomeEnabled',
        value: value,
      ));
    });
  }
...
extension AlarmModelQuerySortBy
  ...
  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy>
      sortByIsSmartHomeEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSmartHomeEnabled', Sort.asc);
    });
  }

  QueryBuilder<AlarmModel, AlarmModel, QAfterSortBy>
      sortByIsSmartHomeEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSmartHomeEnabled', Sort.desc);
    });
  }
...
extension AlarmModelQueryWhereDistinct
  ...
  QueryBuilder<AlarmModel, AlarmModel, QDistinct>
      distinctByIsSmartHomeEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSmartHomeEnabled');
    });
  }
...
extension AlarmModelQueryProperty
  ...
  QueryBuilder<AlarmModel, bool, QQueryOperations>
      isSmartHomeEnabledProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSmartHomeEnabled');
    });
  }
