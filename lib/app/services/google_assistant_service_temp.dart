...
/// This is a temporary implementation to allow the app to build successfully.
  ...
  Future<bool> _handleCreateAlarm(Map<dynamic, dynamic> args) async {
    try {
      ...
      try {
        ...
        // Still return true as the alarm was saved to the database
      }
